...
const getNotes = async (req, res) => {
  try{
    ...
    console.error(error);
    res.status(500).json({ error: "Sorry, an error occurred while fetching notes." });
  }
};
...
const getNote = async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ error: "Sorry, an error occurred while getting note." });
  }
...
const createNote = async (req, res) => {
  ...
  console.error(error);
  res.status(500).json({ error: "Sorry, an error occurred while creating notes." });
}
};
...
const updateNote = async (req, res) => {
  try{
    ...
    console.error(error);
    res.status(500).json({ error: "Sorry, an error occurred while updating notes." });
  }
};
...
const addTagToNote = async (req, res) => {
  ...
  console.error(error);
  res.status(500).json({ error: "Sorry, an error occurred while adding the tag." });
}
};
const createUser = async (req, res) => {
  ...
  console.error(error);
  res.status(500).json({ error: "Sorry, an error occurred while creating user." });
}
};
